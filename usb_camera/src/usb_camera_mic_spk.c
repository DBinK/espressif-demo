    ...
    switch (event) {
        case STREAM_CONNECTED: {
            ...
            if (frame_size) {
                ...
                for (size_t i = 0; i < frame_size; i++) {
                    ESP_LOGI(TAG,
                             "\t [%u] ch_num = %u, bit_resolution = %u, samples_frequence = %"PRIu32 ", samples_frequence_min = %"PRIu32 ", samples_frequence_max = %"PRIu32,
                ...
                ESP_LOGI(TAG,
                         "UAC MIC: use frame[%u] ch_num = %"PRIu32", bit_resolution = %"PRIu32", samples_frequence = %"PRIu32,
            ...
            if (frame_size) {
                ...
                ESP_LOGI(TAG,
                         "UAC SPK: use frame[%u] ch_num = %"PRIu32", bit_resolution = %"PRIu32", samples_frequence = %"PRIu32,
